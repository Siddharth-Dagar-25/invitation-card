...
import frontImage from "../utils/Red And Black Modern Namaste Logo.png";
      ...
      <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gray-950 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            Wishing you a fantastic day filled with joy, laughter, and countless reasons to smile. To know more click below
            </p>
          ...
          <div className="relative mt-4 h-80 lg:mt-8">
            <img
